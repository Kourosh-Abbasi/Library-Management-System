...
public class Library {
    ...
    public boolean CheckCommand(String command) {
        ...
        if (command.equals("fuck")
                ...
                || command.equals("/help")
                || command.equals("hlp")
                || command.equals("guide")
                || command.equals("options")
                || command.equals("option")
                || command.equals("show options")
                || command.equals("exit")
    ...
    public void RunByCommand() {
        ...
        for (; ; ) {
            ...
            switch (command) {
                ...
                case "help": case "/help": case "hlp": case "guide": case "options": case "option": case "show options": {
                    ShowOptions();
                    continue;
                }
                case "mew":
